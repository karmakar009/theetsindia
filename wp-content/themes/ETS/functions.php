...
function what_we_do_post_type() {
    $labels = array(
        'name'                  => _x( 'What We Do', 'Post type general name', 'textdomain' ),
        'singular_name'         => _x( 'What We Do', 'Post type singular name', 'textdomain' ),
        'menu_name'             => _x( 'What We Do', 'Admin Menu text', 'textdomain' ),
        'name_admin_bar'        => _x( 'What We Do', 'Add New on Toolbar', 'textdomain' ),
        'add_new'               => __( 'Add New', 'textdomain' ),
        'add_new_item'          => __( 'Add New', 'textdomain' ),
        'new_item'              => __( 'New Items', 'textdomain' ),
        'edit_item'             => __( 'Edit Items', 'textdomain' ),
        'view_item'             => __( 'View Items', 'textdomain' ),
...
add_action( 'init', 'what_we_do_post_type' );
...
function our_services_custom_post() {
    $labels = array(
...
add_action( 'init', 'our_services_custom_post' );

function my_login_logo_one() { 
?> 
<style type="text/css"> 
body.login div#login h1 a {
 background-image: url(<?php echo get_template_directory_uri();?>/assets/img/ETS-Global-ISO-Logo-2015.png);
...
function career_custom_post() {
    $labels = array(
        'name'                  => _x( 'Career Opportunity', 'Post type general name', 'textdomain' ),
        'singular_name'         => _x( 'Career Opportunity', 'Post type singular name', 'textdomain' ),
        'menu_name'             => _x( 'Career Opportunity', 'Admin Menu text', 'textdomain' ),
        'name_admin_bar'        => _x( 'Career Opportunity', 'Add New on Toolbar', 'textdomain' ),
        'add_new'               => __( 'Add New', 'textdomain' ),
        'add_new_item'          => __( 'Add New Career Opportunity', 'textdomain' ),
        'new_item'              => __( 'New Career Opportunity', 'textdomain' ),
        'edit_item'             => __( 'Edit Career Opportunity', 'textdomain' ),
        'view_item'             => __( 'View Career Opportunity', 'textdomain' ),
       'all_items'              => __( 'All Career Opportunity', 'textdomain' ),
        'search_items'          => __( 'Search Career Opportunity', 'textdomain' ),
        'parent_item_colon'     => __( 'Parent Career Opportunity:', 'textdomain' ),
        'not_found'             => __( 'No Career Opportunity found.', 'textdomain' ),
        'not_found_in_trash'    => __( 'No Career Opportunity found in Trash.', 'textdomain' ),
    ...
    $args = array(
        ...
        'show_in_menu'       => true,
        'query_var'          => true,
        'rewrite'            => array( 'slug' => 'career_opportunity' ),
        'capability_type'    => 'post',
        'has_archive'        => true,
        'hierarchical'       => false,
        'menu_position'      => null,
    ...
    register_post_type( 'career_opportunity', $args );
}
add_action( 'init', 'career_custom_post' );
/*  function custom_admin_menu(){
      $page_title = 'Test Menu';
...
add_action( 'wp_ajax_requirement_ajax', 'career_requirement_ajax_callback' );
add_action( 'wp_ajax_nopriv_requirement_ajax', 'career_requirement_ajax_callback' );
 
function career_requirement_ajax_callback(){
	?>
	gbbgtfrbgrt
	<?php
