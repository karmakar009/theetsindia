		...
		<div class="owl-carousel owl-theme banner-slider" style="padding-top:40">
			<div class="item">
				<div class="container mrg40T mrg40B">
					<div class="img-warp">
						<img src="assets/img/thumb-01.png" width="100%" alt=""/>
					</div>
					<div class="item-top">responsive web design</div>
					<div class="item-mid">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. <br>
	...
	<div class="container">
		<div class="row">
			<div class="owl-carousel owl-theme statistics-slider" style="padding-top:40" align="center">
				<div class="item">Completed 1000+ Projects throughout the Globe</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 pad40T pad40B">                
				...
				<div class="owl-carousel owl-theme about-video-slider banner-slider1" style="margin-top:55px">

                    <div  class="embed-responsive embed-responsive-16by9">
                        <object id="ETSvedio" class="embed-responsive-item" data="https://www.youtube.com/embed/tNa5aUT79B8?rel=0&autoplay=0&loop=0&wmode=opaque&controls=0&showinfo=0&theme=light" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></object>
                    </div>
                    <div class="embed-responsive embed-responsive-16by9">
                        <object id="ETSvedio1" class="embed-responsive-item" data="https://www.youtube.com/embed/mGMiE6hYYsU?rel=0&autoplay=0&loop=0&wmode=opaque&controls=0&showinfo=0&theme=light" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></object>
                    </div>
					<div class="embed-responsive embed-responsive-16by9">
                        <object id="ETSvedio2" class="embed-responsive-item" data="https://www.youtube.com/embed/1B42Jnj6n04?rel=0&autoplay=0&loop=0&wmode=opaque&controls=0&showinfo=0&theme=light" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></object>
                    </div>
			...
			<div class="col-sm-6 ">
                <div class="about-top">
					<h1 style="font-size:16pt"><strong> Software Development company in Kolkata, India</strong></h1>
				</div>
				<div style="margin-top:-31px">
					<h2>ETS in a nutshell</h2>
				</div>
                <div class="about-mid text-justify">
					<p class="content-texte">
                     Eclipse Technoconsulting Global Private Ltd. or ETS is a leading 
                    <b> software Developmentcompany in Kolkata, India</b>,
                     established in 2013. We are the most reliable and trustworthy
                     web solutions developing company that provides holistic applications all built with great 
                     technological expertise and highly advanced program frameworks. We constantly innovate and 
                     aggravate your business development progress through successful implementation of software 
                     and applications to yield highest possible profitable returns for your business. We develop
                     tailor-made and high-end software, applications and web designs and portals that serve as 
                     the best fit for your commercial setting. We ensure that we always focus on the use of dynamic
                     and up-to-date solutions that are the future harbingers of growth for your business</p>
                </div>
                <div class="pad20T pad30B">
                    <a href="https://www.theetsindia.com/about-us" class="btn btn-info">READ MORE</a>
                </div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-sm-4 pad15B">
				<div class="well well-theme red" align="center">
					<div class="img-container">
                        <img src="assets/img/offer-01.jpg" alt="Web Development" width="100%">
					</div>
					<div class="header-container">ERP</div>
					<div class="matter-container" align="center">
						<b>Let the Globe know what you do using web</b>
					</div>
					<div class="pad20T">
                        <a href="https://www.theetsindia.com/webapplication-development" class="btn btn-red">MORE</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4 pad15B">
                <div class="well well-theme blue" align="center">
                    <div class="img-container">
                        <img src="assets/img/offer-02.jpg" alt="ERP Development" width="100%">
                    </div>
                    <div class="header-container">Trading Platfrom</div>
                    <div class="matter-container" align="center">
						<b>Enlightening the spirit of IT in your business</b>
						<!--<p class="content-texte">Do you want to increase your revenue by saving time? Do you want to manage your whole business only by mouse click? Do you want all your departments work in parallel with your defined set of goals? Answers of all these question is simply implementation of ERP. We develop custom ERP solution for small and medium scale industry for constraint of budget and also implement large scale ERP like Oracle EBS or SAP for large scale industries.</p>--></div>
                    <div class="pad20T">
                        <a href="https://www.theetsindia.com/enterprise-solutions" class="btn btn-red">MORE</a>
                    </div>
                </div>
			</div>
			<div class="col-sm-4 pad15B">
				<div class="well well-theme red" align="center">
					<div class="img-container">
                        <img src="assets/img/offer-03.jpg" alt="Digital Marketing" width="100%">
					</div>
					<div class="header-container">Web design &amp; development</div>
					<div class="matter-container" align="center">
						<b>The smartest and economical way of marketing</b>
					</div>
					<div class="pad20T">
                        <a href="https://www.theetsindia.com/digital-marketing-services" class="btn btn-red">MORE</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4 pad15B">
				<div class="well well-theme blue" align="center">
					...
					<div class="header-container">Mobile application</div>
					<div class="matter-container" align="center">
						<b>Let the Globe know what you do using web</b>
					</div>
					<div class="pad20T">
			...
			<div class="col-sm-4 pad15B">
                <div class="well well-theme red" align="center">
                    ...
                    <div class="header-container">E-commerce</div>
                    <div class="matter-container" align="center">
						<b>Enlightening the spirit of IT in your business</b>
						<!--<p class="content-texte">Do you want to increase your revenue by saving time? Do you want to manage your whole business only by mouse click? Do you want all your departments work in parallel with your defined set of goals? Answers of all these question is simply implementation of ERP. We develop custom ERP solution for small and medium scale industry for constraint of budget and also implement large scale ERP like Oracle EBS or SAP for large scale industries.</p>--></div>
                    <div class="pad20T">
			...
			<div class="col-sm-4 pad15B">
				<div class="well well-theme blue" align="center">
					...
					<div class="header-container">Digital Marketing</div>
					<div class="matter-container" align="center">
						<b>The smartest and economical way of marketing</b>
					</div>
					<div class="pad20T">
			...
			<div class="col-sm-12 pad40B" align="center">
                <a href="https://www.theetsindia.com/services" class="btn btn-red mrg20T">View All</a>
			</div>
		</div>
	</div>
</div>
...
<div class="container-fluid bg-why-choose">
	<div class="container">
		<div class="row">
			<h2 class="text-center pad40T pad40B">WHY CHOOSE US</h2>
			<div class="col-sm-4 pad30B" align="center">
				<div class="img-container">
                    <img src="assets/img/ISO-9001-2015-logo1.png" alt="ISO 9001:2015 Certified logo" class="zoom" width="191px">
                    
				</div>
				<div class="txt-container">ISO 9001:2015 Certified</div>
			</div>
			
			<div class="col-sm-4 pad30B" align="center">
				<div class="img-container">
                    <img src="assets/img/choose-03.png" alt="Quality preference " class="zoom" width="191px">
				</div>
				<div class="txt-container">24 X 7 Availability</div>
			</div>
			<div class="col-sm-4 pad30B" align="center">
				<div class="img-container">
                    <img src="assets/img/choose-04.png" alt="Experienced Management" class="zoom" width="191px">
				</div>
				<div class="txt-container">In-house skilled resources</div>
			</div>
			<div class="col-sm-4 pad30B" align="center">
				<div class="img-container">
                    <img src="assets/img/choose-05.png" alt="Latest Technology Preference" class="zoom" width="191px">
				</div>
				<div class="txt-container">Govt. Registered Organization</div>
			</div>
			<div class="col-sm-4 pad30B" align="center">
				<div class="img-container">
                    <img src="assets/img/choose-06.png" alt="Customer Satisfaction" class="zoom" width="191px">
				</div>
				<div class="txt-container">Unlimited revisions for design</div>
			</div>
			<div class="col-sm-4 pad30B" align="center">
				<div class="img-container">
                    <img src="assets/img/choose-06.png" alt="Customer Satisfaction" class="zoom" width="191px">
				</div>
				<div class="txt-container">FREE Lifetime support</div>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
            ...
            <div class="row allImgHol" id="products_details">
				<div class="col-sm-4 pad10A">
					<div class="imgHolder">
						<img src="assets/img/offer-01.jpg" alt="" width="100%">
						<div class="headertext pad15A">
							<p class="mrg0B">Web based Purchase Order Management system</p>
						</div>
						<div class="row pad15L pad15R">
							<div class="col-sm-6 mrg15B" align="center">
								<button id="" type="button" class="btn btn-info"> Ask for Quote</button>
							</div>
							<div class="col-sm-6 mrg15B" align="center">
								<a href="/Home/portfolioDetails/1">details... </a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-sm-4 pad10A">
					<div class="imgHolder">
						<img src="assets/img/offer-02.jpg" alt="" width="100%">
						<div class="headertext pad15A">
							<p class="mrg0B">Restaurant order management</p>
						</div>
						<div class="row pad15L pad15R">
							<div class="col-sm-6 mrg15B" align="center">
								<button id="" type="button" class="btn btn-info"> Ask for Quote</button>
				...
				<div class="col-sm-4 pad10A">
					<div class="imgHolder">
						<img src="assets/img/offer-03.jpg" alt="" width="100%">
						<div class="headertext pad15A">
							<p class="mrg0B">Enterprise Resource Planning software</p>
						</div>
						<div class="row pad15L pad15R">
							<div class="col-sm-6 mrg15B" align="center">
								<button id="" type="button" class="btn btn-info"> Ask for Quote</button>
				...
				<div class="col-sm-4 pad10A">
					<div class="imgHolder">
						<img src="assets/img/offer-02.jpg" alt="" width="100%">
						<div class="headertext pad15A">
							<p class="mrg0B">Trading software</p>
						</div>
						<div class="row pad15L pad15R">
							<div class="col-sm-6 mrg15B" align="center">
								<button id="" type="button" class="btn btn-info"> Ask for Quote</button>
				...
				<div class="col-sm-4 pad10A">
					<div class="imgHolder">
						<img src="assets/img/offer-03.jpg" alt="" width="100%">
						<div class="headertext pad15A">
							<p class="mrg0B">Android application development</p>
						</div>
						<div class="row pad15L pad15R">
							<div class="col-sm-6 mrg15B" align="center">
								<button id="" type="button" class="btn btn-info"> Ask for Quote</button>
				...
				<div class="col-sm-4 pad10A">
					<div class="imgHolder">
						<img src="assets/img/offer-01.jpg" alt="" width="100%">
						<div class="headertext pad15A">
							<p class="mrg0B">Electronic Health Record management System</p>
						</div>
						<div class="row pad15L pad15R">
							<div class="col-sm-6 mrg15B" align="center">
								<button id="" type="button" class="btn btn-info"> Ask for Quote</button>
            ...
            <div class="col-sm-12 " align="center">
                <a href="https://www.theetsindia.com/portfolio" class="btn btn-red mrg20T">View All</a>
            </div>
	...
	<div class="container">
		<div class="row">
				...
				<div class="item">
					<div class="row text-center-switch">
                        <div class="col-sm-2 vcenter" align="center">
                            ...
                            <img class="img-circle" src="assets/img/port-01.jpg" alt="Aron_beny.jpg" width="80%">
                            
                        </div>
						<div class="col-sm-9 vcenter">
							<div class="matter">Awesome team, always available, worked primarily with Bapita and team. Very satisfied with support and team availability. Bapita been helping me even from home. Rohan took initiative of presenting me with better solutions.<br>Thank you. </div>
                            <br>
                            <div class="img-header">Aron Beny </div>
                            <div class="img-sub-head">United States</div>
						</div>
					</div>
				</div>
				<div class="item">
            ...
            <div class="col-sm-12 pad10T" align="center">
                <a href="https://www.theetsindia.com/testimonials" class="btn btn-red ">View All</a>
            </div>
